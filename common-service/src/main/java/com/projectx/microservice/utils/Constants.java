package com.projectx.microservice.utils;
...
public class Constants {
    ...
    public static final String DISCOUNT_EXIST="Discount already exists try other!!";
    public static final String DISCOUNT_NOT_EXIST="Discount details not present in the system!!";
